...
public class SqlLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String ID_MAIN_CAT = "ID_";
    public static final String NAME_MAIN_CAT = "name_";
    public static final String PAYMENT = "PAYMENT";
    public static final String ID_PAYMENT = "ID_";
    public static final String VALUE_PAYMENT = "VALUE_";
    public static final String DATE_PAYMENT = "DATE_";
    public static final String MAIN_CAT_PAYMENT = "MAIN_CAT_ID_";
    public static final String SUB_CAT_PAYMENT = "SUB_CAT_ID";
    public static final String NAME_SUB_CAT = "name_";
    public static final String ID_SUB_CAT = "ID_";
    ...
    public void onCreate(SQLiteDatabase mySQL)
    {
        ...
        mySQL.execSQL("INSERT INTO "+ MAIN_CAT +" VALUES('1','Kleidung');");
        mySQL.execSQL("INSERT INTO "+ MAIN_CAT +" VALUES('2','Tank');");
        mySQL.execSQL("INSERT INTO "+ MAIN_CAT +" VALUES('3','Essen');");

        mySQL.execSQL("INSERT INTO "+ SUB_CAT +" VALUES('1','H&M','1');");
        mySQL.execSQL("INSERT INTO "+ SUB_CAT +" VALUES('2','Shell','2');");
        mySQL.execSQL("INSERT INTO "+ SUB_CAT +" VALUES('3','New Yorker','1');");

        mySQL.execSQL("INSERT INTO "+ PAYMENT + " VALUES('0','500','100000000','0','1');");
        mySQL.execSQL("INSERT INTO "+ PAYMENT + " VALUES('1','150','100000000','0','2');");
